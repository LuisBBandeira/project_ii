...
Este enunciado define os requisitos e os marcos para o Projeto II, cujo objetivo é transformar o pitch desenvolvido no módulo de Pitching e Empreendedorismo numa aplicação funcional. Os grupos já foram definidos pelo tutor do curso, e os projetos foram selecionados a partir das ideias apresentadas no módulo de Pitching. A meta é converter o pitch num MVP.
...
- Defina o escopo do MVP, colocando as melhorias para o desenvolvimento do projeto. O escopo deve definir um comparativo entre o que está no pitching e o que o grupo assumirá na fase de desenvolvimento no que diz respeito às funcionalidades de cada projeto, definindo assim o produto mínimo viável.  
- Defina claramente os papeis, responsabilidades e tarefas de cada membro, especificando-as.  
...
- **Modelo de dados, Conteinerização e Arquitetura:**  
...
- **Outros Aspetos:**  
  ...
  - Mais uma vez, a documentação deve estar atualizada durante o desenvolvimento do projeto.

## **4. Fases do Projeto**

O projeto está dividido em três fases distintas, a serem desenvolvidas ao longo de 14 sessões (3 horas cada) e uma sessão final de apresentação (4 horas).

### **Fase 1: Definição do Âmbito e Planeamento (3 Sessões)**

- **Cronograma**: 

Aproximadamente as 3 primeiras sessões.
...
- **Entregáveis**:  
  ...
  - **Definição de Papeis e Tarefas:** Delinear de forma clara as responsabilidades de cada membro, assegurando que todos contribuam na apresentação do projeto, no desenvolvimento técnico e na documentação.  
  - **Plano Técnico**: Especificar a arquitetura do sistema, o conjunto de tecnologias e a estratégia de conteinerização.  
...
Aproximadamente da sessão 4 à 14\.
...
Sessão final dedicada à apresentação.
...
- Aos projetos de pitching selecionados, caberá ao criador do projeto o papel de ‘Owner’ ou ‘Leader’ do grupo.   
- Cada elemento, independente do grupo a que calhou, deverá fazer um fork do repositório do projeto ( https://github.com/jorgealves-learning/project\_ii ), onde tenham de copiar todas as branches do repositório (ver o step 6 de Fork a repository \- GitHub Docs). no github e deverá fazer o trabalho técnico que lhe será atribuído em grupo.  
...
- **Implementação Técnica**:  
  ...
  - Utilização eficaz de containers (obrigatório Docker e Docker Compose; Terraform e Kubernetes como bónus).  
